...
export const CHARACTERS = {
  alan: {
    ...
    accent: "#d13b22", maxPV: 10, maxPD: 16,
  ...
  edgar: {
    ...
    accent: "#d13b22", maxPV: 18, maxPD: 10,
  ...
  eloisa: {
    ...
    accent: "#4a84cf", maxPV: 12, maxPD: 14,
  ...
  kenia: {
    ...
    accent: "#4a84cf", maxPV: 12, maxPD: 12,
  ...
  victor: {
    ...
    accent: "#5f9e3e", maxPV: 14, maxPD: 14,
